              ...
              >
                <div className="rounded-[24px] border border-[#2A2A2A] bg-[#141414] p-5 text-white">
                  <div className="space-y-4">
                    <div>
                      <p className="text-sm font-black tracking-tight text-[#F4D35E]">{'\u{1F947}'} PLACAR EXATO → 25 pontos</p>
                    ...
                    <div>
                      <p className="text-sm font-black tracking-tight text-[#EAB308]">{'\u{1F3C6}'} VENCEDOR + GOLS DO VENCEDOR → 18 pontos</p>
                    ...
                    <div>
                      <p className="text-sm font-black tracking-tight text-[#38BDF8]">{'\u{2696}\u{FE0F}'} VENCEDOR + SALDO DE GOLS → 15 pontos</p>
                    ...
                    <div>
                      <p className="text-sm font-black tracking-tight text-[#A78BFA]">{'\u{1F3AF}'} VENCEDOR + GOLS DO PERDEDOR → 12 pontos</p>
                    ...
                    <div>
                      <p className="text-sm font-black tracking-tight text-[#4ADE80]">{'\u{2705}'} VENCEDOR CERTO → 10 pontos</p>
                    ...
                    <div>
                      <p className="text-sm font-black tracking-tight text-[#F87171]">{'\u{274C}'} SEM PONTOS → 0 pontos</p>
